...
int PEM_write_bio_P11PROV_PK11_URI(BIO *out, const P11PROV_PK11_URI *x)
{
    return PEM_ASN1_write_bio((i2d_of_void *)i2d_P11PROV_PK11_URI,
                              P11PROV_PEM_LABEL, out, x, ((const EVP_CIPHER*)0),
                              ((const uint8_t*)0), 0, ((pem_password_cb *)0), ((void *)0));
}
...
{
    return (P11PROV_PK11_URI*) PEM_ASN1_read_bio((d2i_of_void *)d2i_P11PROV_PK11_URI,
